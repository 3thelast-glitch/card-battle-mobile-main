...
export interface AbilityData {
    ...
    nameAr: string;
    description: string;
    /** تحذير / شرط خاص يظهر باللون الأحمر أسفل الوصف */
...
export function AbilityCard({ ability, showActionButtons = true, onToggleDisabled }: Props) {
    ...
    // تحقق هل في البيانات حقل descriptionWarning بالبحث في data/abilities
...
const styles = StyleSheet.create({
    ...
    legendaryEdgeGlow:   { ...StyleSheet.absoluteFillObject, borderWidth: 2, borderColor: 'rgba(245,158,11,0.30)', borderRadius: 20, shadowColor: '#f59e0b', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.8, shadowRadius: 22, elevation: 10 },

  ...
  return (
    <ScreenContainer>
      ...
      <View style={styles.container}>
        ...
        {/* ✅ Battle Area - عمودي */}
        <View style={styles.battleAreaVertical}>
          
          {/* البطاقة العلوية - البوت */}
          <View style={styles.cardSectionTop}>
          ...
          {/* البطاقة السفلية - اللاعب */}
          <View style={styles.cardSectionBottom}>
